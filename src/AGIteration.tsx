...
const AGInteractive = ({
  ...
  log(
    [
      `AGInteractive initialized as ${stateful ? '' : 'not '}stateful. ${
        stateful
          ? 'AGInteractive will provide its own InteractiveConfigContext Provider and state.'
